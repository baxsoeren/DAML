...
In dieser Arbeit soll untersucht werden, wie das Kaufverhalten und die Kauftrends der Kunden in den USA ist. Anschließend sollen mehrere Modelle entwickelt werden, welche Beispielsweise voraussagen, ob <mark>[...].</mark>
...
```{r}
ggplot(shopping_behavior, aes(x = "", y = Age)) +
  geom_boxplot() +
  labs(x = NULL, y = "Alter")
