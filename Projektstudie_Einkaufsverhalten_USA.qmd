...
Zudem erstellen wir noch die Spalte Express_Shipping_Used, welche für einen Purchase_Amount von über 100 "Yes"  und für einen Purchase_amount von unter 100 "No" ist. Die Spalte wird hinterher in Modell 3 und 4 genutzt.
...
Zum Schluss dieser Arbeit möchten wir diese nochmals kritisch betrachten. Hierzu gehen wir zunächst auf das verwendete Datenset und im Anschluss auf unsere Arbeitsweisen ein. Dabei hinterfragen wir besonders unser Vorgehen und die erzielten Ergebnisse. 

Das Datenset ist für für die Beantwortung unserer Thesen geeignet. Es umfasst einen Umfang von Rund 3700 Einträgen und ist somit ausreichend repräsentativ. 
Es gibt jedoch auch einige Kritikpunkte die wir an dieser Stelle anbringen möchten.

1. Kein Kaufdatum

Bei den Datensätzen sind keine Kaufdaten hinterlegt. Dies wäre bei der Beantwortung der Thesen x und x von Vorteil gewesen, um die Thesen besser zu stützen oder sogar aufgrunddessen wiederlegen zu können. 

2. Keine Umsätze über 100$

Es gibt keine Datensätze, welche einen Umsatz von über 100 $ aufweisen.

Nun zu unserer Arbeitsweise. Allgemein sind wir strukturiert vorgegangen. Die Thesen wurden ausreichend gründlich analysiert und hinreichend belegt oder wiederlegt. Die Ergebnisse sind nachvollziehbar und die verwendeten Methoden sind angemessen. Hätte das Datenset tiefergreifende Informationen gehabt, hätten die Thesen noch tieferlegend analysiert werden können um so eine bessere Basis für das Erstellen der Modelle zu schaffen. 

Würden wir diese Arbeit erneut durchführen, würden wir ein anderes Datenset nehmen, welches die Informationen des Kaufdatums und der Umsätze von über 100$ beinhaltet. 

Negativ: Kein Kaufdatum vorhanden, Purchase_Amount nur unter 100$
