...
Nun wandeln wir "Frequency of Purchases" um. Und zwar werden die Werte zu folgenden Zahlen: "Fortnightly" = 2, "Weekly" = 1, "Annually" = 3

Nun wandeln wir Previous Purchases in den Typen dbl um:

```{r}
shopping_behavior$"Previous Purchases" = as.numeric(shopping_behavior$"Previous Purchases")
```

Nun wandeln wir Previous Purchases in den Typen dbl und geben jeder Häufgkeit eine Zahl:

```{r}
shopping_behavior$"Frequency of Purchases" = as.numeric(case_when(
  shopping_behavior$"Frequency of Purchases" == "Annually" ~ 1,
  shopping_behavior$"Frequency of Purchases" == "Bi-Weekly" ~ 2,
  shopping_behavior$"Frequency of Purchases" == "Every 3 Months" ~ 3,
  shopping_behavior$"Frequency of Purchases" == "Fortnightly" ~ 4,
  shopping_behavior$"Frequency of Purchases" == "Monthly" ~ 5,
  shopping_behavior$"Frequency of Purchases" == "Quarterly" ~ 6,
  shopping_behavior$"Frequency of Purchases" == "Weekly" ~ 7))
```

Nun wandeln wir die Seasons in Zahlen um:

```{r}
shopping_behavior$"Season" = as.numeric(case_when(
  shopping_behavior$"Season" == "Winter" ~ 1,
  shopping_behavior$"Season" == "Spring" ~ 2,
  shopping_behavior$"Season" == "Summer" ~ 3,
  shopping_behavior$"Season" == "Fall" ~ 4))
...
Nun erstellen wir einen Boxplot für das Alter der Kunden:
